...
export const createSpellDefinitions = (): SpellDefinition[] => [
  {
    id: 'arcane-burst',
    name: 'Arcane Burst',
    description: 'A focused blast of raw mana.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 0,
    manaCost: 20,
    baseDamage: 10,
    damagePerLevel: 1.1,
    statScaling: { intelligence: 1.6, spirit: 0.4 },
    skillScaling: { arcana: 2.8, combat: 0.4 },
  },
  {
    id: 'ember-lance',
    name: 'Ember Lance',
    description: 'A piercing fire lance with high single-target force.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 8,
    manaCost: 24,
    baseDamage: 14,
    damagePerLevel: 1.25,
    statScaling: { intelligence: 1.8, spirit: 0.3 },
    skillScaling: { arcana: 3.0, combat: 0.3 },
  },
  {
    id: 'frost-shard',
    name: 'Frost Shard',
    description: 'A stable ice shard that scales well with control.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 12,
    manaCost: 22,
    baseDamage: 12,
    damagePerLevel: 1.2,
    statScaling: { intelligence: 1.5, spirit: 0.6 },
    skillScaling: { arcana: 2.9, combat: 0.25 },
  },
  {
    id: 'storm-javelin',
    name: 'Storm Javelin',
    description: 'Lightning-quick strike with sharp damage growth.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 18,
    manaCost: 28,
    baseDamage: 16,
    damagePerLevel: 1.35,
    statScaling: { intelligence: 1.9, spirit: 0.35 },
    skillScaling: { arcana: 3.1, combat: 0.35 },
  },
  {
    id: 'stone-spear',
    name: 'Stone Spear',
    description: 'Dense earth-forged projectile backed by discipline.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 24,
    manaCost: 26,
    baseDamage: 18,
    damagePerLevel: 1.3,
    statScaling: { intelligence: 1.4, spirit: 0.9 },
    skillScaling: { arcana: 2.7, combat: 0.5 },
  },
  {
    id: 'void-spike',
    name: 'Void Spike',
    description: 'A dangerous void puncture with heavy scaling.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 32,
    manaCost: 34,
    baseDamage: 24,
    damagePerLevel: 1.5,
    statScaling: { intelligence: 2.2, spirit: 0.45 },
    skillScaling: { arcana: 3.6, combat: 0.4 },
  },
  {
    id: 'solar-flare',
    name: 'Solar Flare',
    description: 'Explosive radiant surge with strong base impact.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 40,
    manaCost: 38,
    baseDamage: 30,
    damagePerLevel: 1.55,
    statScaling: { intelligence: 2.1, spirit: 0.6 },
    skillScaling: { arcana: 3.8, combat: 0.35 },
  },
  {
    id: 'lunar-ray',
    name: 'Lunar Ray',
    description: 'A calm but relentless beam of moonlit mana.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 50,
    manaCost: 42,
    baseDamage: 34,
    damagePerLevel: 1.6,
    statScaling: { intelligence: 2.0, spirit: 0.9 },
    skillScaling: { arcana: 4.0, combat: 0.3 },
  },
  {
    id: 'rift-cleaver',
    name: 'Rift Cleaver',
    description: 'Cuts through reality and punishes high-level foes.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 64,
    manaCost: 48,
    baseDamage: 40,
    damagePerLevel: 1.75,
    statScaling: { intelligence: 2.4, spirit: 0.7 },
    skillScaling: { arcana: 4.3, combat: 0.45 },
  },
  {
    id: 'astral-collapse',
    name: 'Astral Collapse',
    description: 'Signature endgame spell with extreme scaling.',
    effectType: 'damage',
    maxLevel: 100,
    requiredArcanaLevel: 80,
    manaCost: 58,
    baseDamage: 52,
    damagePerLevel: 2.0,
    statScaling: { intelligence: 2.8, spirit: 1.0 },
    skillScaling: { arcana: 4.8, combat: 0.5 },
  },
  {
    id: 'vital-bloom',
    name: 'Vital Bloom',
    description: 'A restorative arcane weave that heals steady amounts.',
    effectType: 'healing',
    maxLevel: 100,
    requiredArcanaLevel: 16,
    manaCost: 26,
    baseDamage: 18,
    damagePerLevel: 1.25,
    statScaling: { intelligence: 1.1, spirit: 1.8 },
    skillScaling: { arcana: 2.4, combat: 0.2 },
  },
  {
    id: 'rift-mend',
    name: 'Rift Mend',
    description: 'A high-tier healing surge fueled by spirit and arcana.',
    effectType: 'healing',
    maxLevel: 100,
    requiredArcanaLevel: 44,
    manaCost: 44,
    baseDamage: 34,
    damagePerLevel: 1.6,
    statScaling: { intelligence: 1.4, spirit: 2.2 },
    skillScaling: { arcana: 3.8, combat: 0.1 },
  },
  {
    id: 'battle-trance',
    name: 'Battle Trance',
    description: 'Arcane focus that boosts weapon and spell output briefly.',
    effectType: 'buff',
    maxLevel: 100,
    requiredArcanaLevel: 22,
    manaCost: 30,
    baseDamage: 16,
    damagePerLevel: 1.1,
    statScaling: { intelligence: 1.3, spirit: 1.0 },
    skillScaling: { arcana: 2.6, combat: 0.6 },
    buffProfile: {
      durationTicks: 8,
      combatDamageBonus: 0.12,
  ...
  },
  {
    id: 'aegis-ward',
    name: 'Aegis Ward',
    description: 'A defensive weave that increases damage reduction and spell stability.',
    effectType: 'buff',
    maxLevel: 100,
    requiredArcanaLevel: 36,
    manaCost: 34,
    baseDamage: 18,
    damagePerLevel: 1.2,
    statScaling: { intelligence: 1.1, spirit: 1.5 },
    skillScaling: { arcana: 2.8, combat: 0.3 },
    buffProfile: {
      durationTicks: 10,
      damageReductionBonus: 0.1,
      spellPowerBonus: 0.08,
    },
  },
]
